...
/** @constructor */
ScalaJS.c.Ljtop_Main$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.Ljtop_Main$.prototype = new ScalaJS.h.O();
ScalaJS.c.Ljtop_Main$.prototype.constructor = ScalaJS.c.Ljtop_Main$;
/** @constructor */
ScalaJS.h.Ljtop_Main$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Ljtop_Main$.prototype = ScalaJS.c.Ljtop_Main$.prototype;
ScalaJS.c.Ljtop_Main$.prototype.refresh__Ljtop_jmx_Client__V = (function(client) {
  client["getAttribute"]("java.lang:type=Memory", "HeapMemoryUsage", (function(data$2) {
    var data = data$2;
    var used = data["getSync"]("used");
    var x = new ScalaJS.c.s_StringContext().init___sc_Seq(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.T.getArrayOf(), ["HeapMemoryUsage used: ", ""]), 1))).s__sc_Seq__T(ScalaJS.m.s_Predef().genericWrapArray__O__scm_WrappedArray(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.O.getArrayOf(), [used])));
    var this$2 = ScalaJS.m.s_Console();
    this$2.out__Ljava_io_PrintStream().println__O__V(x)
  }));
  client["getAttribute"]("java.lang:type=Threading", "ThreadCount", (function(count$2) {
    var count = count$2;
    var x$1 = new ScalaJS.c.s_StringContext().init___sc_Seq(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.T.getArrayOf(), ["ThreadCount: ", ""]), 1))).s__sc_Seq__T(ScalaJS.m.s_Predef().genericWrapArray__O__scm_WrappedArray(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.O.getArrayOf(), [count])));
    var this$4 = ScalaJS.m.s_Console();
    this$4.out__Ljava_io_PrintStream().println__O__V(x$1)
  }));
  client["getAttribute"]("java.lang:type=ClassLoading", "TotalLoadedClassCount", (function(count$2$1) {
    var count$1 = count$2$1;
    var x$2 = new ScalaJS.c.s_StringContext().init___sc_Seq(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.T.getArrayOf(), ["TotalLoadedClassCount: ", ""]), 1))).s__sc_Seq__T(ScalaJS.m.s_Predef().genericWrapArray__O__scm_WrappedArray(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.O.getArrayOf(), [count$1])));
    var this$6 = ScalaJS.m.s_Console();
    this$6.out__Ljava_io_PrintStream().println__O__V(x$2)
  }));
  client["getAttribute"]("java.lang:type=MemoryPool,name=PS Eden Space", "Type", (function(data$2$1) {
    var data$1 = data$2$1;
    var this$8 = ScalaJS.m.s_Console();
    this$8.out__Ljava_io_PrintStream().println__O__V(data$1)
  }));
  client["getAttribute"]("java.lang:type=MemoryPool,name=PS Eden Space", "Usage", (function(data$2$2) {
    var data$3 = data$2$2;
    var used$1 = data$3["getSync"]("used");
    var x$3 = new ScalaJS.c.s_StringContext().init___sc_Seq(ScalaJS.m.s_Predef().wrapRefArray__AO__scm_WrappedArray(ScalaJS.asArrayOf.O(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.T.getArrayOf(), ["PS Eden Space used: ", ""]), 1))).s__sc_Seq__T(ScalaJS.m.s_Predef().genericWrapArray__O__scm_WrappedArray(ScalaJS.makeNativeArrayWrapper(ScalaJS.d.O.getArrayOf(), [used$1])));
    var this$10 = ScalaJS.m.s_Console();
    this$10.out__Ljava_io_PrintStream().println__O__V(x$3)
  }))
});
ScalaJS.c.Ljtop_Main$.prototype.init___ = (function() {
  ScalaJS.n.Ljtop_Main = this;
  return this
});
ScalaJS.c.Ljtop_Main$.prototype.main__V = (function() {
  var this$2 = ScalaJS.m.s_Console();
  this$2.out__Ljava_io_PrintStream().println__O__V("Creating client");
  var client = ScalaJS.m.Ljtop_jmx_JMX().createClient__Ljtop_jmx_ClientConfiguration__Ljtop_jmx_Client(new ScalaJS.c.Ljtop_jmx_ClientConfiguration().init___T__I("localhost", 8855));
  var this$4 = ScalaJS.m.s_Console();
  this$4.out__Ljava_io_PrintStream().println__O__V("Connecting...");
  client["connect"]();
  client["on"]("connect", (function(client$1) {
    return (function() {
      return (ScalaJS.m.Ljtop_Main().refresh__Ljtop_jmx_Client__V(client$1), (void 0))
    })
  })(client))
});
ScalaJS.c.Ljtop_Main$.prototype.$$js$exported$meth$main__O = (function() {
  return (this.main__V(), (void 0))
});
ScalaJS.c.Ljtop_Main$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
ScalaJS.is.Ljtop_Main$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ljtop_Main$)))
});
ScalaJS.as.Ljtop_Main$ = (function(obj) {
  return ((ScalaJS.is.Ljtop_Main$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "jtop.Main$"))
});
ScalaJS.isArrayOf.Ljtop_Main$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ljtop_Main$)))
});
ScalaJS.asArrayOf.Ljtop_Main$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Ljtop_Main$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Ljtop.Main$;", depth))
});
ScalaJS.d.Ljtop_Main$ = new ScalaJS.ClassTypeData({
  Ljtop_Main$: 0
}, false, "jtop.Main$", ScalaJS.d.O, {
  Ljtop_Main$: 1,
  sjs_js_JSApp: 1,
  O: 1
});
ScalaJS.c.Ljtop_Main$.prototype.$classData = ScalaJS.d.Ljtop_Main$;
ScalaJS.n.Ljtop_Main = (void 0);
ScalaJS.m.Ljtop_Main = (function() {
  if ((!ScalaJS.n.Ljtop_Main)) {
    ScalaJS.n.Ljtop_Main = new ScalaJS.c.Ljtop_Main$().init___()
  };
  return ScalaJS.n.Ljtop_Main
});
ScalaJS.e["jtop"] = (ScalaJS.e["jtop"] || {});
ScalaJS.e["jtop"]["Main"] = ScalaJS.m.Ljtop_Main;
/** @constructor */
ScalaJS.c.Ljtop_jmx_ClientConfiguration = (function() {
  ScalaJS.c.O.call(this);
  this.host$1 = null;
  this.port$1 = 0
});
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype = new ScalaJS.h.O();
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.constructor = ScalaJS.c.Ljtop_jmx_ClientConfiguration;
/** @constructor */
ScalaJS.h.Ljtop_jmx_ClientConfiguration = (function() {
  /*<skip>*/
});
ScalaJS.h.Ljtop_jmx_ClientConfiguration.prototype = ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype;
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.productPrefix__T = (function() {
  return "ClientConfiguration"
});
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.productArity__I = (function() {
  return 2
});
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if (ScalaJS.is.Ljtop_jmx_ClientConfiguration(x$1)) {
    var ClientConfiguration$1 = ScalaJS.as.Ljtop_jmx_ClientConfiguration(x$1);
    return ((ScalaJS.anyRefEqEq(this.host$1, ClientConfiguration$1.host$1) && (this.port$1 === ClientConfiguration$1.port$1)) && ClientConfiguration$1.canEqual__O__Z(this))
  } else {
    return false
  }
});
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.host$1;
...
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.toString__T = (function() {
  return ScalaJS.m.sr_ScalaRunTime().$$undtoString__s_Product__T(this)
});
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.canEqual__O__Z = (function(x$1) {
  return ScalaJS.is.Ljtop_jmx_ClientConfiguration(x$1)
});
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.init___T__I = (function(host, port) {
  this.host$1 = host;
  this.port$1 = port;
  return this
});
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.hashCode__I = (function() {
  var acc = -889275714;
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, ScalaJS.m.sr_Statics().anyHash__O__I(this.host$1));
  acc = ScalaJS.m.sr_Statics().mix__I__I__I(acc, this.port$1);
  return ScalaJS.m.sr_Statics().finalizeHash__I__I__I(acc, 2)
});
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.productIterator__sc_Iterator = (function() {
  return new ScalaJS.c.sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
ScalaJS.is.Ljtop_jmx_ClientConfiguration = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ljtop_jmx_ClientConfiguration)))
});
ScalaJS.as.Ljtop_jmx_ClientConfiguration = (function(obj) {
  return ((ScalaJS.is.Ljtop_jmx_ClientConfiguration(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "jtop.jmx.ClientConfiguration"))
});
ScalaJS.isArrayOf.Ljtop_jmx_ClientConfiguration = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ljtop_jmx_ClientConfiguration)))
});
ScalaJS.asArrayOf.Ljtop_jmx_ClientConfiguration = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Ljtop_jmx_ClientConfiguration(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Ljtop.jmx.ClientConfiguration;", depth))
});
ScalaJS.d.Ljtop_jmx_ClientConfiguration = new ScalaJS.ClassTypeData({
  Ljtop_jmx_ClientConfiguration: 0
}, false, "jtop.jmx.ClientConfiguration", ScalaJS.d.O, {
  Ljtop_jmx_ClientConfiguration: 1,
  s_Serializable: 1,
...
ScalaJS.c.Ljtop_jmx_ClientConfiguration.prototype.$classData = ScalaJS.d.Ljtop_jmx_ClientConfiguration;
/** @constructor */
ScalaJS.c.Ljtop_jmx_ClientConfiguration$ = (function() {
  ScalaJS.c.O.call(this)
});
...
ScalaJS.h.Ljtop_jmx_ClientConfiguration$.prototype = ScalaJS.c.Ljtop_jmx_ClientConfiguration$.prototype;
ScalaJS.c.Ljtop_jmx_ClientConfiguration$.prototype.toLiteral__Ljtop_jmx_ClientConfiguration__sjs_js_Dynamic = (function(client) {
  return {
    "host": client.host$1,
    "port": client.port$1
  }
...
ScalaJS.c.Ljtop_jmx_ClientConfiguration$.prototype.$classData = ScalaJS.d.Ljtop_jmx_ClientConfiguration$;
ScalaJS.n.Ljtop_jmx_ClientConfiguration = (void 0);
ScalaJS.m.Ljtop_jmx_ClientConfiguration = (function() {
  if ((!ScalaJS.n.Ljtop_jmx_ClientConfiguration)) {
    ScalaJS.n.Ljtop_jmx_ClientConfiguration = new ScalaJS.c.Ljtop_jmx_ClientConfiguration$().init___()
  };
  return ScalaJS.n.Ljtop_jmx_ClientConfiguration
});
/** @constructor */
ScalaJS.c.Ljtop_jmx_JMX$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.Ljtop_jmx_JMX$.prototype = new ScalaJS.h.O();
ScalaJS.c.Ljtop_jmx_JMX$.prototype.constructor = ScalaJS.c.Ljtop_jmx_JMX$;
/** @constructor */
ScalaJS.h.Ljtop_jmx_JMX$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Ljtop_jmx_JMX$.prototype = ScalaJS.c.Ljtop_jmx_JMX$.prototype;
ScalaJS.c.Ljtop_jmx_JMX$.prototype.createClient__Ljtop_jmx_ClientConfiguration__Ljtop_jmx_Client = (function(options) {
  var jmx = ScalaJS.g["require"]("jmx");
  return jmx["createClient"](ScalaJS.m.Ljtop_jmx_ClientConfiguration().toLiteral__Ljtop_jmx_ClientConfiguration__sjs_js_Dynamic(options))
});
ScalaJS.is.Ljtop_jmx_JMX$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Ljtop_jmx_JMX$)))
});
ScalaJS.as.Ljtop_jmx_JMX$ = (function(obj) {
  return ((ScalaJS.is.Ljtop_jmx_JMX$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "jtop.jmx.JMX$"))
});
ScalaJS.isArrayOf.Ljtop_jmx_JMX$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Ljtop_jmx_JMX$)))
});
ScalaJS.asArrayOf.Ljtop_jmx_JMX$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Ljtop_jmx_JMX$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Ljtop.jmx.JMX$;", depth))
});
ScalaJS.d.Ljtop_jmx_JMX$ = new ScalaJS.ClassTypeData({
  Ljtop_jmx_JMX$: 0
}, false, "jtop.jmx.JMX$", ScalaJS.d.O, {
  Ljtop_jmx_JMX$: 1,
  O: 1
});
ScalaJS.c.Ljtop_jmx_JMX$.prototype.$classData = ScalaJS.d.Ljtop_jmx_JMX$;
ScalaJS.n.Ljtop_jmx_JMX = (void 0);
ScalaJS.m.Ljtop_jmx_JMX = (function() {
  if ((!ScalaJS.n.Ljtop_jmx_JMX)) {
    ScalaJS.n.Ljtop_jmx_JMX = new ScalaJS.c.Ljtop_jmx_JMX$().init___()
  };
  return ScalaJS.n.Ljtop_jmx_JMX
});
...
//# sourceMappingURL=jtop-fastopt.js.map

//ScalaJS.g["require"] = function() {
//  "jmx": require('jmx'),
//  "blessed": require('blessed'),
//  "blessed_contrib": require('blessed-contrib')
//};
